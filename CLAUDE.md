...
작업 전 README.md의 문서 표와 AGENTS.md를 읽은 뒤 Docs/PROJECT_STATE.md, Docs/CANON.md, Docs/DECISIONS.md, Docs/ARCHITECTURE.md를 순서대로 읽는다. 사무실이나 캐릭터 화면을 작업할 때는 Docs/ART_STYLE.md와 Docs/OFFICE_V0_2.md도 읽는다. clean `main`인지 확인한 뒤에만 수정한다.
