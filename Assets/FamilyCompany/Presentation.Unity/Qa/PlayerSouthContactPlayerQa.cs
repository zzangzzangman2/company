...
{
    public sealed class PlayerSouthContactPlayerQa : MonoBehaviour
    {
        private const string EnableArgument = "-playerSouthContactQa";
        private const string OutputArgument = "-playerSouthContactQaOutput";
        ...
        private static void InstallIfRequested()
        {
            ...
            new GameObject("~PlayerSouthContactPlayerQa").AddComponent<PlayerSouthContactPlayerQa>();
        }
        ...
        private IEnumerator Start()
        {
            ...
            for (var phaseIndex = 0; phaseIndex < 6; phaseIndex++)
            {
                ...
                Capture(camera, target, Path.Combine(output, $"player-south-contact-player-phase-{phaseIndex}.png"));
            }

            Debug.Log(
                "PLAYER_SOUTH_CONTACT_D3D11_PLAYER_QA: PASS | " +
        ...
        {
            Debug.LogError("PLAYER_SOUTH_CONTACT_D3D11_PLAYER_QA: FAIL | " + message);
            Application.Quit(2);
