...
{
    /// <summary>
    /// Builds a strictly isolated showroom from the four new identity candidates.
    /// It never changes the production character catalog or default player build.
    /// </summary>
    public static class Family3DIdentityCandidateBuilder
    {
        public const string Contract = "FC-FAMILY-3D-IDENTITY-CANDIDATE-LAB-V1";
        public const string ScenePath =
            "Assets/FamilyCompany/Experimental/Family3DPrototype/Scenes/Family3DIdentityCandidateLab.unity";
        ...
        public const string GeneratedMaterialRoot =
            "Assets/FamilyCompany/Experimental/Family3DPrototype/Generated/IdentityCandidateMaterials";
        public const string DefaultBuildRoot = "Artifacts/Family3DIdentityCandidateV1/BuildRun1";
        ...
        [MenuItem("Family Company/Experimental/Build New Family 3D Identity Candidate Lab")]
        ...
        public static void BuildFromCommandLine()
        {
            ...
            {
                Build(ResolveBuildRoot());
                Debug.Log("FAMILY_3D_IDENTITY_CANDIDATE_BUILD: PASS");
                EditorApplication.Exit(0);
            }
            catch (Exception exception)
            {
                Debug.LogException(exception);
                Debug.LogError("FAMILY_3D_IDENTITY_CANDIDATE_BUILD: FAIL | " + exception.Message);
        ...
        private static void Build(string buildRoot)
        {
            ...
            scene.name = "Family3DIdentityCandidateLab";
            ...
            var directorObject = new GameObject("Family3DIdentityCandidateShowroomDirector");
            var director = directorObject.AddComponent<Family3DShowroomDirector>();
            director.Configure(camera, actors);

            EditorSceneManager.MarkSceneDirty(scene);
            if (!EditorSceneManager.SaveScene(scene, ScenePath))
                throw new InvalidOperationException("Could not save isolated identity scene: " + ScenePath);

            Directory.CreateDirectory(buildRoot);
            string executablePath = Path.Combine(buildRoot, "FamilyCompany3DIdentityCandidateLab.exe");
        ...
        {
            var host = new GameObject("Family3DIdentity_" + definition.Id.Replace(' ', '_'));
        ...
        {
            var cameraObject = new GameObject("Family3DIdentityReviewCamera");
        ...
        private static void CreateLighting()
        {
            ...
            var keyObject = new GameObject("IdentityKeyLight");
            ...
            var fillObject = new GameObject("IdentityFillLight");
        ...
        private static void CreateFloorAndGrid()
        {
            ...
            floor.name = "IdentityNeutralReviewFloor";
        ...
        private static void CreatePathOutline(CandidateDefinition definition)
        {
            ...
            CreateLine(
                definition.Id.Replace(' ', '_') + "_IdentityCandidateRoute",
                points,
                CreateMaterial(
        ...
        private static string ResolveBuildRoot()
        {
            ...
            string allowedRoot = Path.GetFullPath(Path.Combine(projectRoot, "Artifacts/Family3DIdentityCandidateV1"))
            ...
            if (!fullRoot.StartsWith(allowedRoot + Path.DirectorySeparatorChar, StringComparison.OrdinalIgnoreCase))
                throw new InvalidOperationException("Refusing non-isolated identity build output: " + fullRoot);
            return fullRoot;
        }
