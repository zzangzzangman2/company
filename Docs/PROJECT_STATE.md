...
1. Claude History V1에서 2000~2003년 12개 실제 회사 데이터와 2000~2026 앵커를 작성하고 검증한다.
2. Codex는 하청 계약, 납기, 품질, 고객 평판을 순수 C# 코어에 구현한다.
3. 업무 큐가 NPC의 실제 웨이포인트 이동과 계약 진행률을 연결하게 한다.
