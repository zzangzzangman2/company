...
**2026-09-07: 흰색 통합 사무실 HUD `fc-win-20260907.2` / sequence 5 공개.**
최신 게임 빌드 commit은 `c519985513f3953e6612467f48c895ac29100bf6`다. 이후 문서 push SHA와 구분한다.
집의 고정 메인은 패치 지원 v2(`ee48a72c`) 그대로이며 정상이다. **같은 EXE를 열면 v5 패치
162,939,018 bytes(155.4 MiB)를 받고 최신판으로 진입한다.** 이 수치는 집의 v2 출발 기준이며 설치 버전에 따라 다르다. 캐시를 미리
...
[이번 공개 전송·게임 검증](Evidence/WhiteHudRelease20260907/README.md) · [회사 인수인계](COMPANY_HANDOFF_2026-09-07.md).

회사 PC 최초 설치는 다음 한 번만 필요하다.

1. [공개 설치 ZIP 받기](https://github.com/zzangzzangman2/company/releases/download/fc-win-20260907.2/FamilyCompany-Windows.zip).
...
이번 v5 ZIP은 273,144,271 bytes이며 SHA-256은
`b42c4f76f94766c12179d3086ca2df4e4352145e01ba7cfc99450622abdfbd86`이다.
