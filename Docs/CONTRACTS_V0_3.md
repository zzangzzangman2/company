...
- 저장: 현재 전체 스키마는 v12다. 계약 제안·상태·기여 인시 외에 내부 업무 목적, 정확한 마감과 고정 기술 보너스/완료 품질을 보존한다. 전체 v1~v11을 읽으며 제품 고객·주간 정산은 별도 의미 상태다. 자세한 소유권은 `STARTER_BUSINESS_LOOP.md`를 따른다.
