...
def main():
    ...
    armature.name = "FatherV19MeshyOnePackage_Armature"
    armature.data.name = "FatherV19MeshyOnePackage_Skeleton"
    mesh.name = "FatherV19MeshyOnePackage"
    mesh.data.name = "FatherV19MeshyOnePackage_Mesh"
    materials[0].name = "FatherV19MeshyOnePackage_Material"
    images[0].name = "father-v19-meshy-one-package-albedo"
    action.name = "FatherV19_Casual_Walk_inplace"
    ...
    receipt = {
        "contract": "FC-FATHER-V19-MESHY-ONE-PACKAGE-UNITY-PREP-V1",
    ...
    print("FATHER_V19_MESHY_ONE_PACKAGE_UNITY_PREP=PASS")
