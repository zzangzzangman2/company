...
def main():
    ...
    unexpected_auxiliary = [obj.name for obj in auxiliary if obj.name != "Icosphere"]
    if unexpected_auxiliary:
        raise RuntimeError(
            "Unexpected auxiliary mesh objects: " + repr(unexpected_auxiliary)
        )
    ...
    armature.name = "OlderSisterV2MeshyOnePackage_Armature"
    armature.data.name = "OlderSisterV2MeshyOnePackage_Skeleton"
    mesh.name = "OlderSisterV2MeshyOnePackage"
    mesh.data.name = "OlderSisterV2MeshyOnePackage_Mesh"
    materials[0].name = "OlderSisterV2MeshyOnePackage_Material"
    images[0].name = "older-sister-v2-meshy-one-package-albedo"
    action.name = "OlderSisterV2_Casual_Walk_inplace"
    ...
    receipt = {
        "contract": "FC-OLDER-SISTER-V2-MESHY-ONE-PACKAGE-UNITY-PREP-V1",
    ...
    print("OLDER_SISTER_V2_MESHY_ONE_PACKAGE_UNITY_PREP=PASS")
